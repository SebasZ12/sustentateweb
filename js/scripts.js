...
$(document).ready(function() {
  ...
  $('nav#menu li.menuitem, #header.root .logo').click(function(e) {
    ...
    body.stop().animate({scrollTop: pos}, '500', 'swing', function() {
        ...
        body.stop().animate({scrollTop: pos - $('#header.root').outerHeight() + 20}, '500', 'swing');
    });
    ...
    if(mobile){
      ...
      $('#header').animate({'padding-bottom':'0px'},100);
  ...
  $('.menuButton').click(function(event) {
    ...
    if(menuOpened==false){     
      ...
      $('#header').animate({'padding-bottom':'194px'},100);
      $('#menu').animate({'top':'50px' , 'margin-left':'0px'},100); 
      menuOpened = true;         
    }     
    else{      
      $('#logo').css({'margin-top':''});
      $('nav#menu .menuitem').animate({'height':'0px'}, 100);
      $('#header').animate({'padding-bottom':''},100);
